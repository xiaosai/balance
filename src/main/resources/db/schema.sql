...
(
    ...
    account VARCHAR(32) NULL DEFAULT NULL COMMENT 'account number',
...
(
    ...
    source_account VARCHAR(32) NOT NULL DEFAULT NULL COMMENT 'source account number',
    destination_account VARCHAR(32) NULL DEFAULT NULL COMMENT 'destination account number',
